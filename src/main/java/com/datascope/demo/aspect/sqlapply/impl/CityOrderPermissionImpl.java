...
@Service
@Slf4j
public class CityOrderPermissionImpl implements PermissionStrategy {
    @Override
    public Expression apply(DataScopeParam dataScopeParam) {
        ...
        Column column = getColumn(DataScopeEnum.BUSINESS_CITY, dataScopeParam);
    ...
    public String getPermissionCode() {
        return DataScopeEnum.BUSINESS_CITY.getCode();
    }
}
